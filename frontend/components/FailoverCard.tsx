...
export default function FailoverCard({
  ...
  return (
    <div className="bg-[var(--failover-bg)] border border-[var(--failover-border)] rounded-2xl p-5 my-4 space-y-4 shadow-[var(--card-shadow)] transition-colors">
      {/* Header Row */}
      <div className="flex items-center gap-2.5">
        <div className="w-5 h-5 rounded bg-blue-600/20 border border-blue-500/40 text-blue-500 flex items-center justify-center text-xs font-bold shrink-0">
          🔄
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[1fr,auto,1fr] items-center gap-4">
        ...
        <div className="bg-[var(--failover-storea-bg)] border border-[var(--danger-border)] rounded-xl p-4 flex flex-col justify-between space-y-2">
          <div className="text-[10px] font-semibold text-[var(--danger-text)] uppercase tracking-wider">
            STORE A · AURA ARTISAN TEAS
          </div>
          <div className="text-sm font-bold text-[var(--text-primary)] leading-tight">
            {storeAProduct}
          </div>
          <div className="text-xs text-[var(--danger-text)] font-medium flex items-center gap-1">
            <span>✕</span>
        ...
        <div className="bg-[var(--failover-storeb-bg)] border border-[var(--success-border)] rounded-xl p-4 flex flex-col justify-between space-y-2">
          <div className="text-[10px] font-semibold text-[var(--success-text)] uppercase tracking-wider">
            STORE B · BOTANICAL LEAF CO.
          </div>
          <div className="text-sm font-bold text-[var(--text-primary)] leading-tight">
            {storeBProduct}
          </div>
          <div className="text-xs text-[var(--success-text)] font-medium flex items-center gap-1 font-mono">
            <span>✓</span>
